...
// this code can be placed directly in vis-2-widgets-sigenergy.html
    ...
    createWidget: function (widgetID, view, data, style) {
        ...
        if (!$div.length) {
            return setTimeout(function () {
                vis.binds["vis-2-widgets-sigenergy"].createWidget(widgetID, view, data, style);
            }, 100);
        }

        var text = '';
        text += 'OID: ' + data.oid + '</div><br>';
        text += 'OID value: <span class="vis-2-widgets-sigenergy-value">' + vis.states[data.oid + '.val'] + '</span><br>';
