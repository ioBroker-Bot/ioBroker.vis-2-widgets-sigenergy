...
## Changelog
### 1.6.13 (2026-04-16)
* (ssbingo) Все виджеты: восстановлено, исправлена загрузка изображений переносом innerHTML в вызов update()

### 1.6.12 (2026-04-16)
* (ssbingo) Все виджеты: исправлен путь изображений через window.location.origin + /vis-2/

### 1.6.11 (2026-04-16)
* (ssbingo) Все виджеты: исправлены пути изображений через абсолютный URL (устраняет проблему путей /vis.0/ и /vis-2/)

### 1.6.10 (2026-04-16)
* (ssbingo) Виджет 9 PV Power: исправлено отображение изображений, механизм идентичен виджету SigenMicro

### 1.6.9 (2026-04-16)
* (ssbingo) Виджет 9 переименован в 'PV Power'

### 1.6.8 (2026-04-16)
* (ssbingo) Добавлен виджет 9: Обзор PV-строк с анимированными стрелками для каждой строки
